...
class BrowserHandler {
  ...
  async enable() {
    ...
    dump(`
      ${this._targetRegistry._targets.size}
    `);
    this._eventListeners = [
      helper.addEventListener(this._targetRegistry, TargetRegistry.Events.TargetCreated, this._onTargetCreated.bind(this)),
      helper.addEventListener(this._targetRegistry, TargetRegistry.Events.TargetChanged, this._onTargetChanged.bind(this)),
      helper.addEventListener(this._targetRegistry, TargetRegistry.Events.TargetDestroyed, this._onTargetDestroyed.bind(this)),
    ];
  }
